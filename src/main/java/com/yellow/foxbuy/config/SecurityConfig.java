...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST,"/user/{id}/ban").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST,"/user/rating/{id}", "/user/{id}/rating").hasAnyRole("USER", "VIP", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE,"/user/**").hasAnyRole("USER", "VIP", "ADMIN")
                        .requestMatchers(HttpMethod.GET,"/user/{id}/rating").hasAnyRole("USER", "VIP", "ADMIN")
